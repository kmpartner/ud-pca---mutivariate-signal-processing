...
topoplotIndieOctave(lf.GainN(:,diploc), EEG.chanlocs,'numcontour',0,'electrodes','numbers','shading','interp');
...
topoplotIndieOctave(filt_topo,EEG.chanlocs,'electrodes','numbers','numcontour',0);
...
topoplotIndieOctave(icmaps(1,:),EEG.chanlocs,'electrodes','numbers','numcontour',0);
